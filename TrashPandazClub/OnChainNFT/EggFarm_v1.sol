...
contract EggFarm is AccessControl{
    ...
    constructor(address _gen3Contract, address _erc20Token){
        gen3Contract = _gen3Contract;
    ...
    function mint(address _minter) private returns(bool){
        Gen3(gen3Contract).mint(_minter);
        return true;
    }
    ...
    // Setter functions
    // Set gen3 contract
    function setGen3Contract(address _gen3Contract) public onlyRole(DEFAULT_ADMIN_ROLE){
        gen3Contract = _gen3Contract;
    }
    // Set + Remove token
